        ...
        <div class="content-right-infor">
            ...
            <div class="row-item">
                <div class="col-item">
                    ...
                    <div class="col1-item-content">
                        <input type="text" id="fullname" name="fullname" path="" value="<?php echo $row["hoTen"] ?>"
                               readonly>
                    </div>
                </div>
                <div class="col-item">
            ...
            <div class="row-item">
                <div class="col-item">
                    ...
                    <div class="col1-item-content">
                        <input type="text" id="faculty" name="faculty" path="" value="<?php echo $row["tenKhoa"] ?>"
                               readonly></input>
                    </div>
                </div>
                <div class="col-item">
            ...
            <div class="row-item">
                <div class="col-item">
                    ...
                    <div class="col1-item-content">
                        <input type="text" id="address" name="address" path="" placeholder="Address"
                               value="<?php echo $row["diaChi"] ?>""></input>
                    </div>
                </div>
                <div class="col-item">
                    <div class="col2-item-title">
                    ...
                    <div class="col2-item-content">
                        <input type="text" id="phoneNumber" name="phoneNumber" path="" placeholder="Phone number"
                               value="<?php echo $row["soDienThoai"] ?>"></input>
                    </div>
                </div>
            ...
            <div class="row-item">
                <div class="col-item">
                    ...
                    <div class="col1-item-content">
                        <input type="text" id="code" name="code" path="" value="<?php echo $row["maNguoiDung"] ?>"
                               readonly></input>
                    </div>
                </div>
                <div class="col-item">
                    ...
                    <div class="col2-item-content">
                        <input type="text" id="nationality" name="nationality" path="" placeholder="Nationality"
                               value="<?php echo $row["quocTich"] ?>"></input>
                    </div>
                </div>
            ...
            <div class="row-item">
                <div class="col-item">
                    ...
                    <div class="col1-item-content">
                        <input type="text" id="khoa" name="khoa" path="" value="<?php echo $row["khoa"] ?>"
                               readonly></input>
                    </div>
                </div>
                <div class="col-item">
                    ...
                    <div class="col2-item-content">
                        <input type="text" id="identitycard" name="identitycard" path="" Placeholder="Identity number"
                               value="<?php echo $row["soCMNDCCCD"] ?>"></input>
                    </div>
                </div>
            ...
            <div class="row-item">
                <button type="button" id="change-information" onclick="clickButtonSaveEditInf()" class="btn btn-primary"
                        style="margin: 25px;">Save Edit
                </button>
            </div>
        </div>
    </div>
...
<div class="after-body">
    ...
    <div class="cover">
        ...
        if ($result->num_rows == 0)
            echo "<p style='margin-left: 20px'>Không có giải thưởng nào</p>";
        else {
            ?>
